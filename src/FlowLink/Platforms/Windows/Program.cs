...
internal class Program
{
    ...
    {
        // MUST be first: Velopack handles install/uninstall/update hooks before app starts
    ...
    private static void HandleHostedAppLaunch(string[] args)
    {
        ...
        Launcher.LaunchUriAsync(new Uri($"flowlink://{package}")).AsTask().GetAwaiter().GetResult();
    }
