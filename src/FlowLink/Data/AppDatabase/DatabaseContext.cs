using FlowLink.Data.AppDatabase.Migrations;
using FlowLink.Data.AppDatabase.Models;
using SQLite;
namespace FlowLink.Data.AppDatabase;
...
public class DatabaseContext
{
    ...
    {
        var databasePath = Path.Combine(ApplicationData.Current.LocalFolder.Path, "flowlink.db");
